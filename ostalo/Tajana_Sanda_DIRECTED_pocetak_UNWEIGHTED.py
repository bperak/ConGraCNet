...
# -*- coding: utf-8 -*-
"""
Created on Mon Feb 26 21:54:48 2024
...
nodes = G.add_weighted_edges_from([(1, 2, 1), (1, 4, 1), (1, 5, 1), (1, 6, 1), (1, 7, 1), (2, 1, 1), (2, 20, 1), (2, 22, 1), (3, 1, 1), (3, 31, 1), (3, 40, 1), (4, 3, 1), (4, 41, 1), (4, 2, 1), (5, 52, 1), (5, 51, 1), (5, 50, 1), (6, 5, 1), (6, 20, 1),(6, 61, 1), (6, 60, 1), (7, 72, 1), (7, 70, 1), (21, 2, 1), (23, 2, 1), (32, 3, 1), (30, 3, 1), (40, 4, 1), (42, 4, 1), (52, 6, 1), (60, 2, 1), (71, 7, 1), (7, 73, 1), (73, 7, 1), (73, 732, 1), (731, 73, 1), (733, 73, 1)]) 
...
for node in G.nodes:
    ...
    for susjed in G.successors(node):
        ...
        #print()
        edge = (node, susjed)
        print(node, "susjed: ", susjed, "odgovarajuci weight", G.get_edge_data(node, susjed)['weight'])#, edge_labels[(1, 40)])
...
#dict2.update({71 : 0.8})
#dict2.update({72 : 0})
#dict2.update({731 : 0.5})
#dict2.update({732 : 0})
#dict2.update({733 : 0.5})
...
#dict4.update({71 : 0})
#dict4.update({72 : 0})
#dict4.update({731 : 0.5})
#dict4.update({732 : 0})
#dict4.update({733 : 0})


#print("Dict4 IN_DEGREE NOVI!", dict4)

#print(dict4)

#print(len(dict4))

#dict4 = {1: 2.55, 2: 6.7, 4: 4.9, 5: 3.5, 6: 2.9, 7: 2.2, 20: 0, 22: 0, 3: 2.4, 31: 0, 40: 0.5, 41: 0, 52: 0, 51: 0, 50: 0, 61: 0, 60: 1.2, 72: 0, 70: 0, 73: 2.0, 732: 0, 731: 0.5, 20 : 0, 22 : 0, 31: 0, 41:0, 51:0, 61:0, 50:0, 52:0, 70:0, 72:0, 731:0.5, 732:0 }
...
def zagradica(node):
    rezultat = dict4[node] + dict2[node]
    return rezultat

for node in G.nodes:
    print("node", node, zagradica(node))
...
for node in G.nodes:
    ...
    for x in list(G.successors(node)):   
        ...
        #print("dict counter veze", dict[(node, x)])
        #dict2['key'] if 'key' in dict2 else 0
        zagrada = zagradica(node) + zagradica(x) - 2*G.get_edge_data(node, x)['weight']#dict2[node]+dict2[x]-()*G.get_edge_data(node, x)['weight']
        print("zagrada", zagrada)
