...
nx.add_cycle(G, [1, 2, 17])
# nx.add_cycle(G, [2, 3, 30])
...
# G.add_edge(1, 21, weight=2)
# G.add_edge(1, 22, weight=1)
# G.add_edge(1, 23, weight=4)
# G.add_edge(1, 24, weight=7)
# G.add_edge(1, 25, weight=6)
# G.add_edge(2, 3, weight=5)
# G.add_edge(2, 30, weight=1)
# G.add_edge(3, 4, weight=1)
# G.add_edge(3, 8, weight=2)
# G.add_edge(4, 6, weight=3)
# G.add_edge(4, 31, weight=5)
# G.add_edge(4, 32, weight=6)
# G.add_edge(5, 3, weight=2)
# G.add_edge(5, 7, weight=3)
# G.add_edge(6, 10, weight=8)
# G.add_edge(6, 11, weight=8)
# G.add_edge(6, 12, weight=6)
# G.add_edge(6, 13, weight=1)
# G.add_edge(7, 17, weight=2)
# G.add_edge(7, 18, weight=3)
# G.add_edge(8, 14, weight=2)
# G.add_edge(8, 15, weight=1)
# G.add_edge(8, 16, weight=1)
# G.add_edge(30, 31, weight=3)

print(G.get_edge_data(1, 2)['weight'])
print(G.get_edge_data(1, 21))
...
#nx.draw_networkx_edge_labels(G, edge_labels ={(n1,n2):widths[n1,n2] for (n1,n2) in widths if widths[n1,n2] >=5}, font_colors='black')
...
def sbb2_importance(G):
    ...
    for node in nx.nodes(G):
        ...
        for susjed in gp.neighborhood(G, node):
            ...
            u = (G.degree(node)+dict1[(node, susjed)]+G.degree(susjed))*edge_weight
