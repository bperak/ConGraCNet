...
# -*- coding: utf-8 -*-
"""
Created on Thu Feb  8 09:01:08 2024
...
def sbb3_importance(G):
    ...
    for node in nx.nodes(G):
        ...
        for susjed in gp.neighborhood(G, node):
            ...
            suma = suma + rezultat
            print('suma', suma)
        print('suma finale', suma+nodeWeight_node)
        nasa_vaznost.append(suma + nodeWeight_node)
        # print(nx.nodes(G))
        # print('suma liste', sum(nasa_vaznost))
        #normirana_lista = []
        #print("nasa_vaznost", sum(nasa_vaznost))
...
#print(nasa_vaznost)
#print(G.nodes)
print("final", sbb3_importance(G))
#print("final suma", sum(sbb3_importance(G)))
