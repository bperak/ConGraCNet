...
# -*- coding: utf-8 -*-
"""
Created on Sun Mar  3 16:00:57 2024

@author: sanda
"""

# Iz grafa smo maknuli kako bi vidjeli koliko ce različit biti poredak vaznosti 
...
def main():
    G = nx.DiGraph()
    weighted_edges = [
         (1, 6, 2.5), (1, 4, 3), (1, 5, 2),  (1, 7, 0.4),  (2, 20, 0.8),
        (2, 22, 0.7), (3, 1, 1.75), (3, 31, 1), (3, 40, 0.5), (4, 41, 0.75), (4, 3, 1.4), (2, 1, 0.8), 
