...
nx.add_cycle(G, [1, 2, 60, 6])
#nx.add_cycle(G, [1, 5, 6, 7])
...
G.add_edge(2, 21, weight=0.8)
G.add_edge(2, 22, weight=0.7)
G.add_edge(2, 60, weight=0.5)
...
G.add_edge(5, 54, weight=1)
#G.add_edge(5, 55, weight=0.4)
G.add_edge(6, 52, weight=0.4)
G.add_edge(6, 53, weight=0.5)
G.add_edge(6, 60, weight=1.2)
G.add_edge(6, 20, weight=1.5)
