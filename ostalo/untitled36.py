...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  4 16:47:50 2024
...
# Compute the eigenvector centrality for the directed graph, considering the edge weights
centrality = nx.eigenvector_centrality_numpy(G, max_iter=1000, tol=1e-06, weight='weight')
